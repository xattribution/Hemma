# Hemma — context for AI/dev sessions
...
**user-visible surfaces** carry the Hemma name (PWA title/manifest, UI copy,
...
see it in user-facing copy, it's a leftover — rebrand it to Hemma.
